class LevelMaps {
  static const List<List<String>> levels = [
    ...
    [
      ...
      "B L ROD RID LID D LOD 4 0 0 0 0 R B",
      "B L R LIT T T LOT 0 ROD D LOD 0 R B",
      "B L R L 0 0 0 0 ROT RIT L 0 R B",
      "B L ROT LOT ROD D LOD 0 0 ROT LOT 0 R B",
      "LIT LOT 0 0 R LIT LOT 0 0 0 0 0 R B",
      "LID LOD 0 0 ROT LOT 0 0 0 B 0 0 R B",
      "B L 0 0 0 0 0 0 B B 0 B R B",
      "B L 0 0 B 0 0 0 6 0 0 B R B",
      "B L 0 0 B B 0 0 0 B B B R B",
      "B L 0 0 22 B 0 0 0 B 66 B R B",
