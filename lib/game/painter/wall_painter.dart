...
class LeftWallCustomPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var paint0Fill = Paint()
      ..style = PaintingStyle.fill
...
class LeftTopOutAngleCustomPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var path_0 = Path()
...
class LeftTopInAngleCustomPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var path_0 = Path()
...
class BottomWallCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    var paint0Fill = Paint()
      ...
      ..color = const Color(0xffF8F4FF).withOpacity(1);
    canvas.drawRect(
      Rect.fromLTWH(0, size.height, size.width * 0.5000000, size.height),
      paint0Fill,
    );
  }
...
class BottomInAngleCustomPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var path_0 = Path()
