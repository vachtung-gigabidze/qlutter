...
import 'package:qlutter/ver_1/app/ui/components/app_transition.dart';
import 'package:qlutter/ver_1/game/models/score.dart';
import 'package:qlutter/ver_1/game/pages/pages.dart';
    ...
    routes: [
      GoRoute(
        ...
        builder: (context, state) =>
            const MainMenuScreen(key: Key('main_menu')),
        routes: [
          GoRoute(
            path: 'play',
